...
export type TestRunner = {
    ...
    expect: <T = unknown>(actual?: T, failMsg?: string) => Matcher<T> & {
...
export declare function retry<T>(fn: () => Promise<T>, condition: (result: T) => boolean, retries: number, delay: number): Promise<T>;
