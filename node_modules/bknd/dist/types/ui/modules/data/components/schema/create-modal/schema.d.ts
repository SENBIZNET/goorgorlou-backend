...
export declare const ModalActions: readonly ["entity", "relation", "media"];
export declare const entitySchema: s.ObjectSchema<{
...
declare const schemaAction: s.Schema<s.IUnionOptions, string, string> & s.Merge<s.IUnionOptions & {
    anyOf: [s.StringSchema<{
        readonly enum: readonly ["entity", "relation", "media"];
    }> & {
        readonly enum: readonly ["entity", "relation", "media"];
    }, s.StringSchema<{
...
declare const createFieldSchema: s.ObjectSchema<{
    readonly entity: s.StringSchema<s.IStringOptions> & s.IStringOptions;
    readonly name: s.StringSchema<s.IStringOptions> & s.IStringOptions;
    readonly field: s.ArraySchema<s.Schema<s.IUnionOptions, {
        name?: string | undefined;
        config?: {
            description?: string | undefined;
            maxLength?: number | undefined;
    ...
    }>, s.IArrayOptions> & s.IArrayOptions;
}, s.IObjectOptions> & s.IObjectOptions;
export type TFieldCreate = s.Static<typeof createFieldSchema>;
declare const createModalSchema: s.ObjectSchema<{
    readonly action: s.Schema<s.IUnionOptions, string, string> & s.Merge<s.IUnionOptions & {
        anyOf: [s.StringSchema<{
            readonly enum: readonly ["entity", "relation", "media"];
        }> & {
            readonly enum: readonly ["entity", "relation", "media"];
    ...
    readonly entities: {
        ...
        properties: {
            readonly create: {
                ...
                }, s.IObjectOptions> & s.IObjectOptions) | undefined;
            } & s.Schema<s.ISchemaOptions, {
                [x: string]: unknown;
        ...
        partial: () => s.ObjectSchema<{
            readonly create: s.Schema<s.ISchemaOptions, {
                [x: string]: unknown;
                type?: "regular" | "system" | "generated" | undefined;
                fields?: {
                    [x: string]: {
    ...
    readonly relations: {
        ...
        properties: {
            readonly create: {
                ...
                maxItems?: number | undefined;
                minItems?: number | undefined;
                readonly items?: (s.Schema<s.IUnionOptions, {
                    config?: {
                        required?: boolean | undefined;
