...
export declare function useBkndAuth(): {
    $auth: {
        roles: {
            none: boolean;
    ...
    schema: import("../../../../modules/mcp").ObjectToolSchema<{
        ...
        readonly jwt: import("jsonv-ts").ObjectSchema<{
            readonly secret: import("../../../../core/utils").SecretSchema<{
                default: string;
            }> & {
                default: string;
            };
    ...
    actions: {
        config: {
            set: (data: Partial<AppAuthSchema>) => Promise<boolean>;
        };
        roles: {
            add: (name: string, data?: any) => Promise<boolean>;
            patch: (name: string, data: any) => Promise<boolean>;
